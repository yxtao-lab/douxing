...
| **§5.5 + 新增** | **发单接单（M 线 · 模块 B）** | **M5 ✅** · **M6 mock ✅**（2026-07-15）· **M7-α** | 真付待 E2 · M7 正式验收可并行；见 [发单接单路线图](./发单接单路线图.md) |
...
> **专项路线图（执行顺序 · 验收）**：[发单接单路线图.md](./发单接单路线图.md) — **MB0～MB3 ✅ · M5 ✅ · M6 mock ✅ · 真付待 E2 · M7-α 并行**
...
| **M7** | [~] | — | 商户端 | M2 | Web `/partner` 工作台（M7-α） | 入驻/大厅/报价/订单联调；验收脚本待补 |
...
| **M** | 发单接单（模块 B） | 商业 / marketplace | [M0～M7](#阶段-m发单接单平台2026-06-09-录入) | S1、H6、E2 | [~]（**M5 ✅** · **M6 mock ✅**，真付待 E2；**M7-α** 可并行验收） |
