...
| **§5.5 + 新增** | **发单接单（M 线 · 模块 B）** | **M5 ✅ · M6 mock ✅ · M7-α ✅**（2026-07-15） | MB4 预览；完整待 E2 + M7-3～5；见 [发单接单路线图](./发单接单路线图.md) |
...
> **专项路线图（执行顺序 · 验收）**：[发单接单路线图.md](./发单接单路线图.md) — **M5 ✅ · M6 mock ✅ · M7-α ✅ · MB4 预览 · 真付/M7-3～5 收口**
...
| **M6** | [~] | 2026-07-15 | 支付与分佣 | M2、E2 | 真实支付 + 商户结算 | **mock 子集 ✅** · 真付待 E2 |
...
| **M** | 发单接单（模块 B） | 商业 / marketplace | [M0～M7](#阶段-m发单接单平台2026-06-09-录入) | S1、H6、E2 | [~]（**M7-α ✅** · MB4 预览；真付与 M7-3～5 收口） |
