...
| **当前焦点** | 阶段 A 已完成 | A1～A4 均已验收 |
| **下一步建议** | B1 | 打卡字段增强（阶段 B） |
| **完成度（里程碑）** | M0：**7/7** 已完成 · A：**4/4** · 其余未开始 | 见 [时间轴](#2-项目开发进度时间轴) |
...
| v0.4.2 | 2026-05-21 | 订单状态机 | pending→paid→completed/cancelled、CAS 支付、超时自动取消 |
