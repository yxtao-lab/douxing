...
| **下一步建议** | 见 **[下一步工作.md](./下一步工作.md)** · **[AI流程编排路线图](./AI流程编排路线图.md)** | **W0 流程编排** · **DT5 二期** · H10 Web 审核 UI · **[发单接单路线图](./发单接单路线图.md) M0**（按需） |
...
> **专项路线图（执行顺序 · 验收）**：[发单接单路线图.md](./发单接单路线图.md) — **当前 M0**

| 步 | 状态 | 计划完成 | 名称 | 依赖 | 交付内容 | 验收标准 |
|----|------|----------|------|------|----------|----------|
| **M0** | [~] | — | 领域建模 | — | 类目、`biz_org`、`service_provider`、`service_demand`/`quote`/`order` 表 | 迁移 + 种子；见 [发单接单路线图 Phase M0](./发单接单路线图.md#phase-m0--领域建模p0--当前) · [§13](./发单接单平台.md#13-m0-领域建模实施清单2026-07-09) |
