...
**新增专题**：[系统管理.md](./系统管理.md) · [发单接单平台.md](./发单接单平台.md) · [发单接单路线图.md](./发单接单路线图.md) · [数字孪生与三维建模.md](./数字孪生与三维建模.md) · [AI旅行宠物.md](./AI旅行宠物.md) · [AI流程编排路线图.md](./AI流程编排路线图.md) · [旅行日记博客.md](./旅行日记博客.md) · [用户粘性与旅友圈战略.md](./用户粘性与旅友圈战略.md) · [旅游市场竞争力与兜行精进建议.md](./旅游市场竞争力与兜行精进建议.md) · [Web管理端表格规范.md](./Web管理端表格规范.md) · [Cursor-Agent规则.md](./Cursor-Agent规则.md)
...
9. [产品待办池（新增关键点）](#9-产品待办池新增关键点)
   ...
   - [9.10 精准化与人群定制待办池](#910-精准化与人群定制待办池2026-07-17-录入)
...
| **当前焦点** | **M6 主链已达成** · **现网百炼模型** · Step 35 PAI **延后** · **H10 Web 审核 ✅** | 公司/对公 **办理中**；见 [下一步工作.md](./下一步工作.md) · [后期待办.md](./后期待办.md) |
| **下一步建议** | 见 **[下一步工作.md](./下一步工作.md)** · **[后期待办.md](./后期待办.md)** | **沙箱真机一笔**（收口 MB4）· G5 上线验收 · DT5 二期（按需） |
...
| v1.1.3 | 2026-07-15 | 发单接单 E2 | **微信通道接线** · `service_order` prepay · notify 双表 · M3～M7 / MB3 验收 · MB4 通道预览 · 下一沙箱真机；见 [发单接单路线图 v1.11.0](./发单接单路线图.md) |
| v1.1.2 | 2026-07-13 | 发单接单 M7-α | **Web 商户工作台** `/partner` · 入驻/大厅/报价/订单 · `db:seed-merchant` · 当时指针仍 M3；见 [发单接单路线图 v1.3.2](./发单接单路线图.md) |
| v1.1.1 | 2026-07-10 | 发单接单 M2 | **MB2** 发单 MVP · `m2:marketplace-demand-cases` · M2-10 C 端入驻表单 |
| v1.1.1 | 2026-07-09 | AI 流程编排 | **C7-W W0～W5 全量验收** · MW1～MW4 · 管理端诊断/沙箱/模板 API · SSE `node_status` | [AI流程编排路线图.md](./AI流程编排路线图.md) |
| v1.1.1 | 2026-07-09 | 发单接单 M0 | **MB0** 领域建模：`0039_marketplace_m0` · `/api/marketplace/*` · `m0:marketplace-cases`；见 [发单接单路线图](./发单接单路线图.md) |
...
| 2026-07-15 | E2 微信通道接线 | [发单接单路线图 v1.11.0](./发单接单路线图.md) · prepay · notify 双表 · 沙箱真机待商户号 |
| 2026-07-15 | M7-4 履约汇报 | [发单接单路线图 v1.10.0](./发单接单路线图.md) · 签到/图文 · `0046` |
| 2026-07-15 | M7-3 排期指派 | [发单接单路线图 v1.9.0](./发单接单路线图.md) · 领队指派 · 行程日历 |
| 2026-07-15 | M7-5 Partner 财务 UI | [发单接单路线图 v1.8.1](./发单接单路线图.md) · `/partner/settlements` |
| 2026-07-15 | M7-α 验收 | [发单接单路线图 v1.8.0](./发单接单路线图.md) · 商户自助一单 · MB4 预览 |
| 2026-07-15 | M6 mock 子集 | [发单接单路线图 v1.7.0](./发单接单路线图.md) · 抽佣/台账 · 真付待 E2 |
| 2026-07-15 | M5 阶段验收 | [发单接单路线图 v1.6.0](./发单接单路线图.md) · 标品直购 · 指针 → M6 |
| 2026-07-15 | M4 / MB3 验收 | [发单接单路线图 v1.5.0](./发单接单路线图.md) · 匹配推送 · 信用排序 · 指针 → M5 |
| 2026-07-15 | M3-5 · M3 阶段验收 | [发单接单路线图 v1.4.0](./发单接单路线图.md) · 公司团建全链 · 指针 → M4 |
| 2026-07-15 | M3-4 · 团体场景 UI | [发单接单路线图 v1.3.9](./发单接单路线图.md) · mobile/pc 团体页 · 发单选团体 |
| 2026-07-14 | M3-3 · 人数与发票 | [发单接单路线图 v1.3.8](./发单接单路线图.md) · 迁移 `0041` · `m3:marketplace-group-cases` |
| 2026-07-14 | M3-2 · 团体发单 | [发单接单路线图 v1.3.7](./发单接单路线图.md) · `publisherGroupId` · `m3:marketplace-group-cases` |
| 2026-07-14 | M3-1 · 团体 CRUD | [发单接单路线图 v1.3.4](./发单接单路线图.md) · `m3:marketplace-group-cases` |
| 2026-07-13 | M7-α · Web 商户工作台提前落地 | [§ M7-α](./开发记录-重难点与亮点.md#m7-α--web-商户工作台提前落地2026-07-13) · [发单接单路线图 v1.3.2](./发单接单路线图.md) |
| 2026-07-09 | C7-W · AI 流程编排（W0～W5 落地） | [§ C7-W 落地](./开发记录-重难点与亮点.md#c7-w--ai-流程编排落地2026-07-0809) · [API §24](./API接口文档.md#24-管理端-ai-流程编排admin) |
| 2026-07-06 | C7-W · AI 流程编排（方案定稿） | [§ C7-W 方案](./开发记录-重难点与亮点.md#c7-w--ai-流程编排方案定稿2026-07-06) · [AI流程编排路线图.md](./AI流程编排路线图.md) |
...
| §3 | AI 智能规划 | 单轮/多轮 LLM + 模板；plan_sessions 追问改方案；**语音输入（ASR）**；**H9 全 Phase** LLM 排 POI + Enricher 住/行 + 路网 polyline + Catalog 班次 + **玩法 RAG**；**C3 景点 RAG** | **[C7 AI Agent 演进](./AI规划与Agent演进.md)**；**[C7-W 流程编排](./AI流程编排路线图.md)**；H8 实时重规划；**[H3 AI 旅行宠物](./AI旅行宠物.md)**；H7 错过景点；[H9+ 远期增强](#h9-远期增强phase-4-之后)；向量库、图片输入 |
...
### 阶段 C7-W：AI 流程编排（2026-07-03 录入）

> **专项路线图**：[AI流程编排路线图.md](./AI流程编排路线图.md) — **Phase W0～W5 · 里程碑 MW1～MW4 · §12 术语表**  
> **设计关联**：[AI规划与Agent演进.md](./AI规划与Agent演进.md) §6 第 2 步「LangGraph 协调器」  
> **原则**：Tool 权威仍在 Node；编排层 **配置化 DAG**；`WORKFLOW_ENGINE=legacy` 默认；不引入 Dify/Coze 双栈；Visual 编辑器按需（W5）。

**背景**：C7-a/b 已落地 16 Tool + 手写 `graph.py`，但流程 **硬编码**、RAG 命中 **不可见**、**无会话级费用**、**无法按预算/天数模板化分支**。流程编排在不推倒 `generateRoute` 前提下补齐可观测、可配置、可计费能力。

| 阶段 | 状态 | 名称 | 交付摘要 | 里程碑 |
|------|------|------|----------|--------|
| **W0** | [x] | 观测基线加固 | NodeSpan · RAG 命中 trace · 规划诊断 API | — |
| **W1** | [x] | LangGraph 运行时 | `graph.py` 图化 · `WORKFLOW_ENGINE` flag · 等价率 ≥95% | **MW1 ✅ 2026-07-08** |
| **W2** | [x] | 观测台与费用 | Web 诊断页 · token/费用 API · 高德调用计数 | **MW2 ✅ 2026-07-08** |
| **W3** | [x] | 工作流模板 | JSON Logic 选模板 · RAG topK/variants 参数化 | **MW3 ✅ 2026-07-08** |
| **W4** | [x] | 准确性验证 | Golden Case 38 条 · CI 回归 | **✅ 2026-07-08**（W4-4 后置） |
| **W5** | [x] | Visual 编辑器 | Vue Flow 拖拽 · 沙箱预览 · SSE 画布执行态 | **MW4 ✅ 2026-07-08～09** |

**与 M6 关系**：W0～W5 可与 M6 **并行**（**已于 2026-07-08～09 全量验收 · MW1～MW4 达成**）；后续按需维护 W4-4 bad case 回流与 LangGraph 动态编译。

**验收命令**：

```bash
pnpm workflow:equivalence   # W1-6 · 需 Node API + ai-service/.venv
pnpm w2:workflow-cost-cases
pnpm w3:workflow-template-cases
pnpm w4:plan-golden-cases
pnpm w5:workflow-graph-cases
```
...
| E2 | [~] | 2026-07-15 | 真实支付 | §5.4 | 微信支付（小程序）+ 回调双表 | **代码接线 ✅** · 沙箱真机一笔待商户号 |
...
| **S1** | [x] | 2026-06-24 | RBAC 闭环 | S0 | `role_menu`；`requirePerm`；登录返回 `permissions` | 运营/审核角色菜单与接口不一致 |
| **S2** | [x] | 2026-06-26 | 动态菜单 | S1 | 侧栏按 `/api/system/menus/tree` + 权限渲染 | `s2:dynamic-menu-cases` 全绿；改种子菜单后前端同步 |
| **S3** | [ ] | — | 运营账号规范 | S1 | 运营用户创建流程；C 端列表筛选 | 不依赖单一 admin 硬编码 |
| **S4** | [ ] | — | 审计增强 | S1 | 敏感操作 oper_log；登录失败记录 | 角色/菜单变更可追溯 |

**推荐顺序**：`S0` → `S1` → `S2` **已完成**；下一步 **S3** 运营账号规范（可选）。**S1 宜在 M1 商户入驻前完成**（已满足）。
...
> **产品全稿**：[发单接单平台.md](./发单接单平台.md)  
> **专项路线图（执行顺序 · 验收）**：[发单接单路线图.md](./发单接单路线图.md) — **M5～M7 ✅ · E2 接线 ✅ · MB4 通道预览 · 沙箱真机一笔收口**

| 步 | 状态 | 计划完成 | 名称 | 依赖 | 交付内容 | 验收标准 |
|----|------|----------|------|------|----------|----------|
| **M0** | [x] | 2026-07-09 | 领域建模 | — | 类目、`biz_org`、`service_provider`、`service_demand`/`quote`/`order` 表 | 迁移 `0039` + seed + `m0:marketplace-cases`；见 [发单接单路线图 Phase M0](./发单接单路线图.md#phase-m0--领域建模p0--2026-07-09) |
| **M1** | [x] | 2026-07-10 | 供给入驻 | M0、S1、H6 | 资质上传、平台审核、服务者主页 | `m1:marketplace-onboard-cases` 全绿 |
| **M2** | [x] | 2026-07-10 | 发单 MVP | M1 | 个人发单 + 报价 + 选定（模拟支付） | `m2:marketplace-demand-cases` 全绿 |
| **M3** | [x] | — | 团体发单 | M2 | `demand_group`（班级/公司/社区） | **✅ 2026-07-15** · `m3:marketplace-group-cases` 公司团建全链 |
| **M4** | [x] | 2026-07-15 | 撮合增强 | M2 | 类目/区域匹配推送、信用排序 | **✅** · `m4:marketplace-match-cases` · **MB3** |
| **M5** | [x] | 2026-07-15 | 标品上架 | M1 | 套餐商品页（标准团/旅拍套餐） | **✅** · `m5:marketplace-product-cases` |
| **M6** | [~] | 2026-07-15 | 支付与分佣 | M2、E2 | 真实支付 + 商户结算 | **通道接线 ✅** · 沙箱真机待商户号 |
| **M7** | [x] | 2026-07-15 | 商户端 | M2 | Web `/partner`（α+排期+汇报+财务） | **α/3/4/5 ✅**；独立子应用远期 |
...
| H10 | [~] | 进行中 | 路线可信度 · UGC 短视频与点评 | 产品传播 | **H10-a/b/c 已交付** · **H10-d 已交付**；见 [H10 分 Phase](#h10-路线可信度--ugc-短视频与点评2026-06-01-录入) | 路线/POI 可挂实拍短视频；POI 展开说明+评论+视频；增强「敢照着走」的信任 |
...
| 平台治理 | 贯穿 | **S（系统管理）** | S0～S2 已完成；S3 运营账号规范待做 |
...
| **平台治理 / 商户生态** | **~~M0~~ ✅ → [M1→M2](#阶段-m发单接单平台2026-06-09-录入)** → M6 + E2 | S1/S2 已完成；模块 B 不阻塞模块 A |
| **系统管理（Web 后台）** | **S3** 运营账号规范（可选） | S0～S2 已完成；见 [系统管理.md](./系统管理.md) |
...
> **M6 主链**：[AI路径规划路线图.md](./AI路径规划路线图.md)  
> **流程编排（并行）**：[AI流程编排路线图.md](./AI流程编排路线图.md) — W0 可与 Step 35 并行  
...
C7-W [x]  W0～W5 ✅ MW1～MW4  ← 见 AI流程编排路线图（2026-07-08～09 验收）
```
...
| H10 | 路线可信度 | 传播 / 信任 · UGC | [H10-a～e](#h10-路线可信度--ugc-短视频与点评2026-06-01-录入) | A2、A3、OSS、H2、D5 | [~] a/b/c ✅ |
| **J** | 旅程相册 · 照片存储 | 内容 / 会员 | [J1～J5](#阶段-j旅程相册与照片存储2026-06-03-录入) | A3、B1、G2、G9、会员等级 | [x]（**J1～J5 已完成**） |
| **P** | PC 用户端（C 端桌面） | 多端 / 体验 | [P0～P5](#阶段-pc-用户端c-端桌面网页2026-06-08-录入) | M0、G9、C/A/B 移动端能力 | [x]（**P0～P5 已完成**） |
| **P6** | PC 体验基建（Tailwind） | 体验 / 工程 | [P6-0～P6-4](#阶段-p6pc-体验基建tailwind-组件与全局反馈2026-06-10-录入) | P0、G9 | [~]（**P6-0～3 已完成**，P6-4 博客片段远期） |
| **S** | 系统管理（平台 RBAC） | 平台 / 安全 | [S0～S4](#阶段-s系统管理2026-06-09-录入) | W1、G9 | [~]（**S0～S2 已完成**，S3/S4 待做） |
| **M** | 发单接单（模块 B） | 商业 / marketplace | [M0～M7](#阶段-m发单接单平台2026-06-09-录入) | S1、H6、E2 | [~]（**E2 接线 ✅** · MB4 通道预览；沙箱真机一笔收口） |
...
### 9.9 市场竞争力补强待办池（2026-07-16 录入）

> **来源**：[旅游市场竞争力与兜行精进建议.md](./旅游市场竞争力与兜行精进建议.md) §6～§8；用于把战略层缺口转译为可排期、可验收的功能待办。  
> **原则**：不替代 ROADMAP / 下一步工作的即时排期； conflict 时以执行文档为准，本文仅做缺口映射与优先级提示。

| 优先级 | ID | 待办项 | 对应市场壁垒 | 当前缺口 | 建议落点 | 验收标准 | 关联文档/阶段 |
|--------|----|--------|--------------|----------|----------|----------|---------------|
| ~~**P0**~~ | **M-TRUST-01** | **模块 B 履约评价与争议处理** | 信任与保障 | ✅ 2026-07-16 交付：双向评价、评价回复、买方申诉、平台仲裁、信用分扣减 | 发单接单 M 线 · 管理端 + 商户端 + C 端 | 买方完成订单后可评价；差评/纠纷可申诉；服务者信用分在报价/大厅可见；Web 管理端可审核/仲裁；`m7-ext:marketplace-trust-cases` 全绿 | [发单接单路线图.md](./发单接单路线图.md) · [发单接单平台.md](./发单接单平台.md) |
| ~~**P0**~~ | **A-CLOSE-01** | **A↔B 弱耦合增强：「按此路线发定制需求」** | 意向 → 落地履约闭环 | ✅ 2026-07-16 交付：移动端/PC 路线详情新增入口，一键带出城市、天数、预算、关键 POI | 移动端/PC 路线详情 + `/api/marketplace/demands` | 已保存/公开路线出现「按此路线定制」入口；一键带出城市、天数、人数、预算、关键 POI；不强制串联；`m2-ext:route-to-demand-cases` 全绿 | [发单接单平台.md](./发单接单平台.md) · ROADMAP §M |
| ~~**P1**~~ | **A-COGNITION-01** | **统一用户旅行画像（可解释的旅行人格）** | 用户认知资产 | ✅ 2026-07-16 交付：画像表 + 聚合 Service + API + 规划注入 | 后端画像服务 + 规划前/行中注入 | 有聚合画像表/服务；规划前可注入「旅行人格」上下文；画像字段可解释（节奏、预算弹性、同伴结构、忌讳等）；`a-cognition:user-persona-cases` 全绿 | [AI规划与Agent演进.md](./AI规划与Agent演进.md) · C7-c 记忆 |
| **P1** | **A-COGNITION-02** | **行程复盘回流 Golden Case / RAG** | AI 反馈环 | 行中打卡、跳过、评价等行为未系统回流训练/检索 | 行程结束后端 + 训练数据管线 | 行程结束后生成「实际 vs 计划」diff；去过/跳过/评价写入 `golden_cases` 或 RAG 记忆；可被后续规划召回 | [AI路径规划路线图.md](./AI路径规划路线图.md) · I1/I3 |
| **P1** | **A-COGNITION-03** | **行中异常主动救场（天气/疲劳/漏打卡）** | 履约闭环 | H7/H8 已能重规划，但缺少基于天气/疲劳/漏打卡的主动提醒与一键改行程 | 行中服务 + 通知服务 | 天气突变/连续疲劳/漏打卡时推送轻量重规划建议；用户一键确认后生成草稿并提示 diff | ROADMAP §H7/H8 · H3-d |
| **P2** | **G-INCENTIVE-01** | **积分兑换主链** | 激励不空转 | 成就/徽章/排行有，但积分消耗闭环不完整 | 用户积分账户 + 兑换商城/权益入口 | 积分可兑换 AI 规划次数、相册配额、会员体验、海报贴纸等核心权益；两端（mobile/pc）可见 | 用户粘性与旅友圈战略.md §3 |
| **P2** | **K-A-01** | **K-A 旅行日记博客启动（K-A1）** | 内容叙事与晒 | 方案定稿，代码未启 | 数据模型 + 公开 API + 模板 MVP | `travel_journals` / `journal_blocks` 表；`GET /share/journals/:token`；私有块不泄漏；2 模板公开页 | [旅行日记博客.md](./旅行日记博客.md) |
| **P2** | **D6-01** | **D6 旅友圈活动流 MVP（D6-a）** | 关系复访 | 方案定稿，代码未启 | 关注/旅友后启动；`social_posts`；打卡/发布/成就自动入圈 | 关注链时间线；默认仅旅友可见；i18n | [用户粘性与旅友圈战略.md](./用户粘性与旅友圈战略.md) |
| **P3** | **STRATEGY-01** | **明确 12 个月内主打圈层** | 圈层垂直深度 | 产品仍偏「通用自助游」，未在单一人群做到默认首选 | 产品决策文档 → 模板/SOP/供给密度 | 从「周末微度假/亲子/小团定制/银发」中选定 1 个主圈层；输出该人群的约束模板、节奏 SOP、供给密度目标 | 旅游市场竞争力与兜行精进建议.md §7.4 |
| **P4** | **A-QUALITY-01** | **H10-e 视频辅助规划（可选）** | 内容可信度 | UGC 视频已可上传播放，但未用于提取 POI 辅助规划 | ASR + 抽帧 OCR + 景点库对齐 | 用户上传 vlog 后提取地名候选；与景点库对齐后推荐写入路线，人工确认后生效 | ROADMAP §H10 |

**维护约定**：
1. 启动某项时，须在对应专项文档（发单接单路线图、AI 路径规划路线图、旅行日记博客等）中补 Step / Phase；不可只留本表。  
2. 验收后更新本表「状态」列（新增 `status` 列）为 `[x]`，并在 §2.2 追加版本记录。  
3. 新增待办项需同步更新 [下一步工作.md](./下一步工作.md) 与 [旅游市场竞争力与兜行精进建议.md](./旅游市场竞争力与兜行精进建议.md) 变更记录。

---

### 9.10 精准化与人群定制待办池（2026-07-17 录入）

> **来源**：产品侧 6 项新想法（场景标签、实时人数、单景点需求、年龄/性别社交、记忆避重、群体主题）。  
> **详述**：[精准化与人群定制路线图.md](./精准化与人群定制路线图.md)  
> **原则**：复用现有 `interestTags`、`attractions.tags`、`user_travel_persona`、`useTheme`；不推倒已有架构；新功能默认纳入 G9 国际化与隐私合规。
...
| **P2** | **P-PROFILE-01** | **年龄/性别 + 同龄人社交** | 同龄人旅行匹配 | `users` 表无 age/gender；D 线未启动 | `birthYear`+`gender`+`ageVisibility` + D6-e 推荐 | 资料可填可控；D6 启动后同龄推荐；隐私政策同步；`p-profile:age-gender-cases` 全绿 | [精准化路线图 §5](./精准化与人群定制路线图.md#5-p-profile-01-年龄性别--同龄人社交) · A1/D6 |
| **P0** | **P-AI-FLOW-01** | **AI 流程优化联动（21 点）** | 标签约束贯穿 AI 全链 | 标签体系引入后 C2/C3/Prompt/Agent/Enricher/编排/降级链未适配 | 21 个优化点嵌入现有 AI 路线图；P0（1/5/7/21）随标签待办同步 | P0 随标签待办验收；`p-ai-flow:optimization-cases` 全绿 | [精准化路线图 §13](./精准化与人群定制路线图.md#13-ai-流程优化联动2026-07-17-录入) · [AI路径规划路线图 §10.1](./AI路径规划路线图.md#101-精准化与-ai-流程优化联动2026-07-17-录入) · [AI规划与Agent演进 §17](./AI规划与Agent演进.md#17-标签约束对-agent-的影响2026-07-17-录入) |

**推荐执行顺序**：`P-TAG-01`（标签基建，专题/需求/主题/规划定制依赖）→ `P-ONBOARD-01`（首次引导 + 分类标签 + 人群推荐，标签消费起点）→ `P-INPUT-01`（规划输入体验，依赖场景标签）→ `P-MEMORY-01`（规划体验立刻见效）→ `P-THEME-01`（视觉差异化）→ `P-LIVE-01` ∥ `P-DEMAND-01` → `P-PROFILE-01`（依赖 D 线社交）。  
**P-AI-FLOW-01**（AI 流程优化联动 21 点）的 **P0 项（1/5/7/21）须与 P-TAG-01 / P-ONBOARD-01 / P-INPUT-01 / P-MEMORY-01 同步落地**，P1/P2/P3 作为后续迭代。

**维护约定**：
1. 启动某项时，须在 [精准化与人群定制路线图.md](./精准化与人群定制路线图.md) 对应章节补 Step / Phase，并在本表更新状态。  
2. 验收后更新本表「状态」为 `[x]`，在 §2.2 追加版本记录。  
3. 新增字段须同步 `@douxing/shared` 类型与 i18n；涉及隐私字段（年龄/性别）须同步 [后期待办.md](./后期待办.md) 合规清单。
