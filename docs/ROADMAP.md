...
| **当前焦点** | **H2-a+** 手帐轻量自定义 · **A2+++ Phase 2** OSS | H2-a + D5-a + v0.8.6 体验扫尾已完成；排期见 [下一步工作.md](./下一步工作.md) |
| **下一步建议** | 见 **[下一步工作.md](./下一步工作.md)** | 主链：H2-a+ → 封面 OSS → H2-b；并行 I2/I3、H9+ |
...
| A2+++ P1 | [~] | 2026-06-01 | 景点封面自动补全 | §3.5 | 高德 POI 图 · sync/读路线 await · 本地盘覆盖策略 · CLI | **已做**：自动拉图 + 注入；**待续**：OSS · Wikimedia · UGC |
...
| P0.5 | **A2+++ OSS** | 封面迁对象存储；多机部署共享；与 H2-a+ 可并行 |
...
**当前 Sprint 范围**：**H2-a+** 轻量自定义 · **A2+++ OSS** · **I2**。  
