...
| **A** | — | [ ] | 阶段 A 完成 | A1～A4 全部验收 | 计划启动：2026-05-21 起 |
| **B** | — | [ ] | 阶段 B 完成 | B1～B6 打卡与游戏化 | 依赖 A2 |
| **C** | — | [ ] | 阶段 C 完成 | C1～C5 AI 深化 | 可与 B 并行 |
...
| 计划完成日 | 步骤 | 目标 |
|------------|------|------|
| 2026-05-21 | — | 在 `.env` 配置腾讯云短信密钥，联调真实短信下发 |
| 2026-05-24 | A1 | 用户资料与偏好可编辑 |
| 2026-05-28 | A2 | 景点基础库 + 种子数据 |
| 2026-06-02 | A4 | 订单状态机与超时取消 |
| 2026-06-07 | A3 | 路线点赞/收藏/热门 |
| 2026-06-21 | B2 + B4 | 地理围栏打卡 + 徽章（阶段 B 首期） |
...
| AI 路线生成 | 2026-05-19 | **DeepSeek** / **LM Studio** / `auto` 模板降级 |
| 路线管理 | 2026-05-19 | 生成、列表、详情、发布、解锁（模拟支付） |
| 打卡 | 2026-05-19 | 按景点名称打卡，写入 `check_ins` |
| 成就 | 2026-05-19 | 3 种规则（首次打卡、累计 3 次、同路线 2 景点） |
...
| §3 | AI 智能规划 | 单轮 LLM（DeepSeek/LM Studio）+ 模板 | 多 Agent、RAG、向量库、多轮对话、语音/图输入 |
...
| Sprint 3–4 | 社交功能 | **B + D** | 未开始 |
| Sprint 5–6 | AI 增强 | **C + F** | 未开始（M0 已含基础 LLM） |
...
| 迭代 4 | 2026-06-15 ～ 06-28 | C1 + C4 | 对话式规划 + 多方案 |
...
| 后端 | Node + 独立 Python AI | Node Express；腾讯云短信（`tencentcloud-sdk-nodejs`） |
| AI | Qwen + LangChain | **DeepSeek** + **LM Studio** + 模板降级 |
