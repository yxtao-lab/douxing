...
> **关联**：详细设计 [§6.7](./详细设计文档.md#67-数字孪生与三维建模实施补充) · [§17.5](./详细设计文档.md#175-数字孪生与三维建模实施补充) · [数据中台 DT5](./数据中台.md#9-dt5-旅行运营大屏) · [旅行运营大屏.md](./旅行运营大屏.md) · ROADMAP [阶段 F](./ROADMAP.md#阶段-farvr-数字孪生与三维建模可后置)

**文档版本**：1.2  
**更新日期**：2026-07-01  
**状态**：**F 线**方案定稿、代码未启动；**DT5 一期**（2D 大屏）已落地，二期 3D 见 [旅行运营大屏 §13](./旅行运营大屏.md#13-全球-3d-地球与动向飞线二期规划)
...
| 空间统计 BI | **ECharts Geo**、漏斗 | 省市区分布、用户路径漏斗 | web DT5 **一期 ✅** |
| 热力 | ECharts heatmap | 打卡密度 | web DT5 **一期 ✅** |
...
| `attractions` 场景字段 | F0 |
| ~~`analytics/geo/*` 聚合 API~~ | ~~DT5 一期 ✅~~ |
| ~~`ScreenLayout` + `/screen/travel`~~ | ~~DT5 一期 ✅~~ |
| glTF 管线、Draco | F2+ |
...
**推荐顺序**：DT5 **2D 大屏一期 ✅**；DT5 加 Cesium 与 F-L3 同步（二期）。
