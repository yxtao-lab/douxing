...
> **当前状态**：**H3-a～d 已验收**（2026-06-18）：领养 API · 悬浮层 · 记忆墙/analyze · **行中 exp/庆祝/in_trip** · **M5 达成**。H3-e 向量记忆待 M6。**文档同步**：2026-06-26。
...
| [AI流程编排路线图.md](./AI流程编排路线图.md) | memory 子图纳入 LangGraph 编排（W1） |
