...
| [openapi.yaml](./openapi.yaml) | **OpenAPI 3.0 规范**（**104** 路径 / **123** 操作；人类可读全量见 [API接口文档 §2](./API接口文档.md#2-接口总览)） |
...
| [发单接单平台.md](./发单接单平台.md) | **模块 B marketplace**：发单/接单、商户组织、与 AI 规划独立、M 线；M0 见 §13 |
| [发单接单路线图.md](./发单接单路线图.md) | **M 线专项路线图**：M0～M7 分步验收 · MB0～MB4 里程碑 |
| [数据中台.md](./数据中台.md) | **数据中台**：指标 API、埋点表、管理端看板与分阶段路线图（DT1～DT5） |
| [系统资源统计.md](./系统资源统计.md) | **数据中台**：远程 Git 工程资产看板（代码/组件/模块/文档与提交趋势） |
| [旅行运营大屏.md](./旅行运营大屏.md) | **DT5 运营大屏**：实现架构、数据口径、缺口与演进方案 |
...
| [AI流程编排路线图.md](./AI流程编排路线图.md) | **流程编排专项**：Tool DAG · LangGraph · 观测/费用 · RAG 节点 · Phase W0～W5 · **§12 专有名词术语表** |
...
| [旅游市场竞争力与兜行精进建议.md](./旅游市场竞争力与兜行精进建议.md) | **市场战略备忘**：2026 旅游竞争力框架 · 对照兜行优势 / 待优化 / 精进方向 |
| [精准化与人群定制路线图.md](./精准化与人群定制路线图.md) | **精准化线**：场景标签/首次引导/标签化规划/避重/群体主题/实时人数/单景点需求/同龄社交 |
...
- **研发 · 模块 A（AI 规划）**：[AI路径规划路线图.md §0](./AI路径规划路线图.md#0-当前指针必读)（**M1～M6 主链已达成** · Step 35 PAI 延后 · **H10 Web 审核 ✅**）→ [AI规划与Agent演进.md](./AI规划与Agent演进.md) → [AI流程编排路线图.md §12 术语表](./AI流程编排路线图.md#12-术语表)（**C7-W W0～W5 · v1.6**）→ 详细设计 §3；旅程相册见 [旅行照片存储系统.md](./旅行照片存储系统.md)  
- **研发 · API 联调**：[API接口文档.md](./API接口文档.md) + [openapi.yaml](./openapi.yaml) · **鉴权**：[双Token认证与无感刷新.md](./双Token认证与无感刷新.md)  
- **研发 · 系统管理（S 线）**：[系统管理.md](./系统管理.md)（**S0～S2 已完成**）  
- **研发 · 数据中台 / 运营大屏**：[数据中台.md](./数据中台.md) · [系统资源统计.md](./系统资源统计.md) · [旅行运营大屏.md](./旅行运营大屏.md)（**DT1～DT3 + DT5 一期 + 系统资源统计已完成**）
- **研发 · 发单接单（M 线）**：[发单接单平台.md](./发单接单平台.md)（产品全稿）· [发单接单路线图.md](./发单接单路线图.md)（**MB0～MB3 ✅ · M5～M7 ✅ · E2 接线 ✅ · 下一沙箱真机一笔**）
- **研发 · 精准化与人群定制**：[精准化与人群定制路线图.md](./精准化与人群定制路线图.md)（P-TAG/P-ONBOARD/P-INPUT/P-MEMORY/P-THEME/P-LIVE/P-DEMAND/P-PROFILE 八项待办）
...
**最后更新**：2026-07-17（**精准化与人群定制待办池录入**：P-TAG/P-ONBOARD/P-INPUT/P-MEMORY/P-THEME/P-LIVE/P-DEMAND/P-PROFILE 八项 · 公司/对公办理中 · M 线指针 → 沙箱真机一笔）
