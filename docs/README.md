...
| [AI规划与Agent演进.md](./AI规划与Agent演进.md) | **设计全稿**：流水线现状 · LangChain/Agent 释义 · 多 Agent · C7 执行流程 |
...
- **产品 / 业务**：详细设计 §1、§4、§5、§17；[发单接单平台.md](./发单接单平台.md)；**H3 旅行宠物**见 [AI旅行宠物.md](./AI旅行宠物.md)；**K-A 旅行日记**见 [旅行日记博客.md](./旅行日记博客.md)；数据中台价值见 [数据中台-价值与行业对照.md](./数据中台-价值与行业对照.md)  
- **研发 · 当前 Sprint**：[下一步工作.md](./下一步工作.md) → [ROADMAP.md](./ROADMAP.md)  
- **研发 · PC 双端分工**：[PC双平台分工.md](./PC双平台分工.md)（新功能放 `pc` 还是 `web`）  
- **研发 · 模块 A（AI 规划）**：详细设计 §2、§3、§7、§12 + ROADMAP；**Agent 演进**见 [AI规划与Agent演进.md](./AI规划与Agent演进.md)；旅程相册见 [旅行照片存储系统.md](./旅行照片存储系统.md)  
...
**最后更新**：2026-06-11（AI 规划与 Agent 演进设计全稿 · ROADMAP C7 执行流程）
