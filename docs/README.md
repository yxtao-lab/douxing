...
| [openapi.yaml](./openapi.yaml) | **OpenAPI 3.0 规范**（**85** 路径 / **102** 操作；人类可读全量见 [API接口文档 §2](./API接口文档.md#2-接口总览)） |
...
| [AI流程编排路线图.md](./AI流程编排路线图.md) | **流程编排专项**：Tool DAG · LangGraph · 观测/费用 · RAG 节点 · Phase W0～W5 |
...
- **研发 · 模块 A（AI 规划）**：[AI路径规划路线图.md §0](./AI路径规划路线图.md#0-当前指针必读)（**M1～M5 已达成 · Step 38/39 已交付 · 当前 Step 35→40 → M6**）→ [AI规划与Agent演进.md](./AI规划与Agent演进.md)（架构设计）→ [AI流程编排路线图.md](./AI流程编排路线图.md)（流程编排 · 与 M6 并行 W0～W5）→ 详细设计 §3；旅程相册见 [旅行照片存储系统.md](./旅行照片存储系统.md)  
...
**最后更新**：2026-07-07（**双 Token 无感刷新** · G5 重难点 · API/openapi 同步 · 管理端刷新白屏修复）
