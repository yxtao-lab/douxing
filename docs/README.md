...
| [openapi.yaml](./openapi.yaml) | **OpenAPI 3.0 规范**（82 个 REST 接口；Apifox / Postman 直接导入） |
...
| [旅行照片存储系统.md](./旅行照片存储系统.md) | **J 线**旅程相册、会员存储配额、J1～J5（含 EXIF · 分享 · 同参数拼图 · 我的相册上传） |
...
- **产品 / 业务**：详细设计 §1、§4、§5、§17；[发单接单平台.md](./发单接单平台.md)；**H3 旅行宠物**见 [AI旅行宠物.md](./AI旅行宠物.md)；数据中台价值见 [数据中台-价值与行业对照.md](./数据中台-价值与行业对照.md)  
- **研发 · PC 双端分工**：[PC双平台分工.md](./PC双平台分工.md)（新功能放 `pc` 还是 `web`）  
- **研发 · 模块 A（AI 规划）**：详细设计 §2、§3、§7、§12 + ROADMAP；**H3 旅行宠物**见 [AI旅行宠物.md](./AI旅行宠物.md)；踩坑查「开发记录-重难点与亮点」  
...
- **平台工程 / 工具选型**：[外部工具与插件推荐.md](./外部工具与插件推荐.md)（ESLint、Sentry、BullMQ、Langfuse 等）
