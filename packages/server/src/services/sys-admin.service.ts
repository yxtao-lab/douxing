...
export const DEFAULT_MENU_SEED: MenuSeedItem[] = [
  ...
  { menuKey: 'partner-schedule', menuName: '行程日历', parentKey: 'partner-workbench', menuType: MenuType.MENU, path: '/partner/schedule', perms: 'marketplace:partner:schedule', icon: 'CalendarOutlined', sortOrder: 26 },
  { menuKey: 'partner-settlements', menuName: '财务结算', parentKey: 'partner-workbench', menuType: MenuType.MENU, path: '/partner/settlements', perms: 'marketplace:partner:settlements', icon: 'AccountBookOutlined', sortOrder: 27 },
  ...
  { menuKey: 'system-resources', menuName: '系统资源统计', parentKey: 'data', menuType: MenuType.MENU, path: '/system-resources', perms: 'data:analytics:view', icon: 'PieChartOutlined', sortOrder: 4 },
  { menuKey: 'plan-diagnostics', menuName: '规划诊断', parentKey: 'data', menuType: MenuType.MENU, path: '/plan-sessions/diagnostics', perms: 'data:analytics:view', icon: 'NodeIndexOutlined', sortOrder: 5 },
  { menuKey: 'workflow-templates', menuName: '工作流模板', parentKey: 'data', menuType: MenuType.MENU, path: '/workflow-templates', perms: 'data:analytics:view', icon: 'ApartmentOutlined', sortOrder: 6 },
  { menuKey: 'route-solver-lab', menuName: '路径算法实验室', parentKey: 'data', menuType: MenuType.MENU, path: '/route-solver-lab', perms: 'data:analytics:view', icon: 'ExperimentOutlined', sortOrder: 7 },
  ...
  { menuKey: 'marketplace-disputes', menuName: '履约争议', parentKey: 'marketplace', menuType: MenuType.MENU, path: '/marketplace/disputes', perms: 'marketplace:dispute:audit', icon: 'WarningOutlined', sortOrder: 255 },
...
export const DEFAULT_ROLE_MENU_KEYS: Record<string, string[] | 'ALL'> = {
  ...
  [RoleCode.AUDITOR]: ['home', 'biz', 'orders', 'content', 'attractions-pending', 'route-media-pending', 'playbooks', 'marketplace', 'marketplace-orgs-pending', 'marketplace-providers-pending', 'marketplace-disputes'],
  [RoleCode.MERCHANT]: [
    'partner-workbench',
    'partner-home',
    'partner-onboard',
