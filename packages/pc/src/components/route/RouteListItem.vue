<template>
  <RouterLink
    ...
    class="group block rounded-2xl border border-dx-border bg-white p-5 shadow-card transition hover:-translate-y-0.5 hover:border-dx-primary/40 hover:shadow-md"
  >
