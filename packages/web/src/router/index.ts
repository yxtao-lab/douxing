    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: {
            requiresAuth: true,
            titleKey: 'web.marketplaceOrgsPending',
        ...
        },
        {
          ...
          redirect: { name: 'partner-onboard', query: { panel: 'org' } },
        },
        {
          path: 'partner/onboard/provider',
          redirect: { name: 'partner-onboard', query: { panel: 'provider' } },
        },
        {
        ...
        },
        {
          ...
          meta: {
            ...
            menuGroupKey: 'web.menu.partnerWorkbench',
            menuSubGroupKey: 'partner.nav.demands',
            hideInMenu: true,
            perm: 'marketplace:partner:demands',
          },
        },
        ...
        },
        {
          ...
          meta: {
            ...
            menuGroupKey: 'web.menu.partnerWorkbench',
            menuSubGroupKey: 'partner.nav.orders',
            hideInMenu: true,
            perm: 'marketplace:partner:orders',
          },
        },
