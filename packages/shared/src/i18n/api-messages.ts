...
const zhCN: Record<string, string> = {
  ...
  [ApiMessageKey.ONBOARDING_COMPLETED]: '引导已完成',
  [ApiMessageKey.ONBOARDING_FAILED]: '引导保存失败',
  [ApiMessageKey.ONBOARDING_INVALID_FIELD]: '引导字段无效：{field}',
  ...
  [ApiMessageKey.PLAN_SESSION_WORKFLOW_TRACE_FAILED]: '获取规划诊断 trace 失败',
  [ApiMessageKey.PLAN_SESSION_COST_SUMMARY_FAILED]: '获取规划费用汇总失败',
  [ApiMessageKey.PLAN_SESSION_ADMIN_LIST_FAILED]: '获取最近规划会话失败',
  [ApiMessageKey.PLAN_SESSION_SANDBOX_RUN_FAILED]: '模拟规划失败',
  [ApiMessageKey.WORKFLOW_TEMPLATE_LIST_FAILED]: '获取工作流模板列表失败',
  [ApiMessageKey.WORKFLOW_TEMPLATE_DETAIL_FAILED]: '获取工作流模板详情失败',
  [ApiMessageKey.WORKFLOW_TEMPLATE_CREATE_FAILED]: '创建工作流模板失败',
  [ApiMessageKey.WORKFLOW_TEMPLATE_UPDATE_FAILED]: '更新工作流模板失败',
  [ApiMessageKey.WORKFLOW_TEMPLATE_DELETE_FAILED]: '删除工作流模板失败',
  [ApiMessageKey.WORKFLOW_TEMPLATE_NOT_FOUND]: '工作流模板不存在',
  [ApiMessageKey.WORKFLOW_TEMPLATE_ALREADY_EXISTS]: '工作流模板 ID 已存在',
  [ApiMessageKey.WORKFLOW_TEMPLATE_BUILTIN_PROTECTED]: '内置兜底模板不可删除',
  [ApiMessageKey.WORKFLOW_GRAPH_VALIDATION_FAILED]: '工作流图校验未通过',
  [ApiMessageKey.WORKFLOW_GRAPH_PUBLISH_FAILED]: '工作流图发布失败',
  [ApiMessageKey.AI_SERVICE_LOG_READ_FAILED]: '读取 AI 服务日志失败',
...
const enUS: Record<string, string> = {
  ...
  [ApiMessageKey.ONBOARDING_COMPLETED]: 'Onboarding completed',
  [ApiMessageKey.ONBOARDING_FAILED]: 'Failed to save onboarding',
  [ApiMessageKey.ONBOARDING_INVALID_FIELD]: 'Invalid onboarding field: {field}',
  ...
  [ApiMessageKey.PLAN_SESSION_WORKFLOW_TRACE_FAILED]: 'Failed to load plan workflow trace',
  [ApiMessageKey.PLAN_SESSION_COST_SUMMARY_FAILED]: 'Failed to load plan cost summary',
  [ApiMessageKey.PLAN_SESSION_ADMIN_LIST_FAILED]: 'Failed to load recent plan sessions',
  [ApiMessageKey.PLAN_SESSION_SANDBOX_RUN_FAILED]: 'Sandbox plan run failed',
  [ApiMessageKey.WORKFLOW_TEMPLATE_LIST_FAILED]: 'Failed to load workflow templates',
  [ApiMessageKey.WORKFLOW_TEMPLATE_DETAIL_FAILED]: 'Failed to load workflow template',
  [ApiMessageKey.WORKFLOW_TEMPLATE_CREATE_FAILED]: 'Failed to create workflow template',
  [ApiMessageKey.WORKFLOW_TEMPLATE_UPDATE_FAILED]: 'Failed to update workflow template',
  [ApiMessageKey.WORKFLOW_TEMPLATE_DELETE_FAILED]: 'Failed to delete workflow template',
  [ApiMessageKey.WORKFLOW_TEMPLATE_NOT_FOUND]: 'Workflow template not found',
  [ApiMessageKey.WORKFLOW_TEMPLATE_ALREADY_EXISTS]: 'Workflow template ID already exists',
  [ApiMessageKey.WORKFLOW_TEMPLATE_BUILTIN_PROTECTED]: 'Built-in fallback template cannot be deleted',
  [ApiMessageKey.WORKFLOW_GRAPH_VALIDATION_FAILED]: 'Workflow graph validation failed',
  [ApiMessageKey.WORKFLOW_GRAPH_PUBLISH_FAILED]: 'Failed to publish workflow graph',
  [ApiMessageKey.AI_SERVICE_LOG_READ_FAILED]: 'Failed to read AI service logs',
